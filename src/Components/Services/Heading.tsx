    ...
    return (
        <Container maxWidth='lg' style={{ display: "grid" }}>
            <Box sx={{
                ...
                <Typography sx={{ fontFamily: "Nobile", fontSize: { lg: "30px", md: "20px", xs: "15px" }, lineHeight: { lg: "40px", xs: "25px" }, fontWeight: 700, color: "#3F485E", maxWidth: "34rem", textAlign: "center" }}>Services </Typography>
